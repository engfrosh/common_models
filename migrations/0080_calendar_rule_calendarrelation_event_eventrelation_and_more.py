# Generated by Django 5.1.4 on 2024-12-28 19:29
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('common_models', '0079_faqpage_img'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calendar', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='common_models.calendar', verbose_name='calendar')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rule', models.ForeignKey(blank=True, help_text="Select '----' for a one time only event.", null=True, on_delete=django.db.models.deletion.SET_NULL, to='common_models.rule', verbose_name='rule')),
            ],
            options={
                'verbose_name': 'event',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('distinction', models.CharField(max_length=20, verbose_name='distinction')),
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype')),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='common_models.event', verbose_name='event')),
            ],
            options={
