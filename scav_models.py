...
class PuzzleStream(models.Model):
    ...
    active_icon = models.ForeignKey('common_models.SiteSVG', on_delete=models.SET_NULL, null=True, blank=True, related_name='streams_using_active_icon')  # noqa: E501
...
class Puzzle(models.Model):
    ...
    stream_puzzle = models.ForeignKey("Puzzle", on_delete=SET_NULL, blank=True, null=True, related_name='puzzle_opener', verbose_name="New branch first puzzle")  # noqa: E501
